...
- Synthetic conditional-shift experiments (`experiments/plot_error_rate.py`, `experiments/plot_test_stat.py`, `experiments/synthetic_power_plot.py`, `experiments/synthetic_dimension.py`) evaluate Type I error, power, and statistic behavior for CMMD$_0$, CMMD$_1$, and CMMD$_2$ under both equal and unequal covariate marginals. These scripts also study sensitivity to signal strength (`\theta`) and input dimension.
